...
namespace EKSystemApp.Persistence.Migrations
{
    ...
    [Migration("20231205122426_MigEmre001")]
            ...
            modelBuilder.Entity("EKSystemApp.Domain.Entities.Admin.Blog.BlogHeadlineManager", b =>
                {
                    ...
                    b.Property<string>("HeadlinePublicStatü")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EKSystemApp.Domain.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("51822923-6b4e-483e-8689-e9e646c33b12"),
                            CompanyName = "Holding"
                        },
                        new
                        {
                            Id = new Guid("174346ce-8dfc-440d-b67b-2d535886a361"),
                            CompanyName = "D&R"
                        },
                        new
                        {
                            Id = new Guid("8b32be52-0c71-4a32-8490-f9667e0d76da"),
