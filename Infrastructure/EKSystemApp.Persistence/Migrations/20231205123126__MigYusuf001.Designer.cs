...
namespace EKSystemApp.Persistence.Migrations
{
    ...
    [Migration("20231205123126__MigYusuf001")]
    partial class _MigYusuf001
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EKSystemApp.Domain.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("07859517-8e0e-484e-a069-14445b420e41"),
                            CompanyName = "Holding"
                        },
                        new
                        {
                            Id = new Guid("9dbd6cee-0e92-40e8-9548-5855c6fd3d6d"),
                            CompanyName = "D&R"
                        },
                        new
                        {
                            Id = new Guid("f0ff083a-56f5-42da-9c28-e65d1043a786"),
